...
# Add ValidationInfo to your imports at the top of the file
...
class Beat(BaseModel):
    ...
    # The @field_validator decorator is the modern way, but your existing one also works.
    # The key change is the function signature and the use of 'info.data'.
    @field_validator("end_sec")
    @classmethod
    def _end_after_start(cls, v: float, info: ValidationInfo) -> float:
        # FIX: Access the data dictionary via the 'info.data' attribute
